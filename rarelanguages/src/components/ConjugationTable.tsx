...
export default function ConjugationTable({
  ...
  return (
    <div className={`bg-success-50 border border-success-200 rounded-lg p-6 ${className}`}>
      <div className="mb-4">
        <h3 className="font-bold text-success-800 mb-2">Verb Conjugation</h3>
      ...
      <div className="space-y-2">
        <div className="font-semibold text-success-700 mb-3">
        ...
        <div className="grid gap-2">
          {personNumberOrder.map(personNumber => {
            ...
            return (
              <div
                key={personNumber}
                className="flex items-center justify-between bg-white rounded-lg p-3 border border-success-100"
              >
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <span className="text-success-600 font-medium min-w-[120px]">
                      {personNumberLabels[personNumber]}:
                    </span>
                    <span className="font-semibold text-success-800 text-lg">
                      {conjugation.form}
                    </span>
                  ...
                  {conjugation.pronunciation && (
                    <div className="mt-1 text-sm text-success-600 ml-[123px]">
                      [{conjugation.pronunciation}]
                    </div>
                  )}
                  ...
                  {conjugation.usage_notes && (
                    <div className="mt-1 text-xs text-success-600 ml-[123px] italic">
                      {conjugation.usage_notes}
                    </div>
                  )}
                </div>
        ...
        <div className="mt-3 text-xs text-success-600 text-center">
